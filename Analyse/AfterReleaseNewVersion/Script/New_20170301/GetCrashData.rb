...
class GetCrashData
	...
	# 获取某一天所有版本的Crash		
	def self.getSingleDayAllVersionCrash(date)
	...
	# 获取某一天某一个版本的Crash	
	def self.getSingleDaySingleVersionCrash(date,version)
		catBaseUrl = "http://cat.dp/cat/r/crash?op=appCrashLogJson&crashLogQuery.day=#{date}&crashLogQuery.startTime=00:00&crashLogQuery.endTime=23:59&crashLogQuery.appName=1&crashLogQuery.platform=2&crashLogQuery.dpid=&crashLogQuery.query=#{version};;;;"
